...
gh repo fork infinite-playing-finite/wild-garden

# Or use the GitHub web interface:
# 1. Go to https://github.com/infinite-playing-finite/wild-garden
...
gh repo clone yourusername/wild-garden
...
Go to:
- [The Garden](https://github.com/infinite-playing-finite/garden) - Structured insights
- [The Wild](https://github.com/infinite-playing-finite/wild) - Raw explorations
...
gh repo clone infinite-playing-finite/garden
...
```bash
# Clone the wild repo
gh repo clone infinite-playing-finite/wild
...
Start with:
- [What Are We Beyond Form?](https://github.com/infinite-playing-finite/garden/blob/main/portals/what-are-we-beyond-form.md)
- [The Triad](https://github.com/infinite-playing-finite/garden/blob/main/portals/the-triad.md)
- [What Is Remembering?](https://github.com/infinite-playing-finite/garden/blob/main/questions/what-is-remembering.md)
...
- Create an issue in the [Garden](https://github.com/infinite-playing-finite/garden/issues)
- Or the [Wild](https://github.com/infinite-playing-finite/wild/issues)
